import { Box, Card, Container, ThemeProvider, Typography } from '@mui/material';
      ...
      <Container>
        ...
        <Box
          ...
          <Card
            ...
            <Typography>
              Наши методики основываются на реальных ситуациях и практических заданиях, что
              позволяет максимально приблизить процесс подготовки к реальной сдаче экзамена.
            </Typography>
          </Card>
        </Box>
      </Container>
